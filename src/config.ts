...
const configurations: { [env: string]: Configuration } = {
  ...
  development: {
    ...
    externalTokens: {
      MIM: ['0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56', 18],
      AVAX: ['0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18],
    ...
    baseLaunchDate: new Date('2022-03-21 23:00:00Z'),
    bondLaunchesAt: new Date('2022-03-21 23:00:00Z'),
    boardroomLaunchesAt: new Date('2022-03-22 23:00:00Z'),
    refreshInterval: 10000,
  },
  production: {
    chainId: 56,
